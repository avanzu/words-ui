...
/**
 * Maps key-codes to dispatchable event names
 *
 * @type {{}}
 */
const eventMap = {
...
/**
 * Returns true if at least one modifier key is pressed.
 *
 * @param event
 * @return {boolean | *}
 */
...
/**
 * prefixes the given base event name on the used event modifier keys.
 *
 * @param event
 * @param baseEventName
 * @return {string}
